...
import { VectorTileLayer, createClusterIcon, buildPinIcon } from "./map-utils";
...
const markerIcons: Record<MapPoint["kind"], ReturnType<typeof divIcon>> = {
  accommodation: buildPinIcon(MARKER_COLORS.accommodation, MARKER_GLYPHS.accommodation),
  activity: buildPinIcon(MARKER_COLORS.activity, MARKER_GLYPHS.activity),
  dive: buildPinIcon(MARKER_COLORS.dive, MARKER_GLYPHS.dive),
};

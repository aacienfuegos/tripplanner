export const es = {
  ...
  diveSiteMaxDepth: (m: number) => `Máx. ${m} m`,
  waterTypeSalt: "Agua salada",
  waterTypeFresh: "Agua dulce",
  waterTypeBrackish: "Agua salobre",
  waterTypeChlorinated: "Agua clorada",
  ...
  diveMediaTitle: "Media",
  diveMediaRemove: "Quitar",
  diveMediaManage: "Gestionar",
  diveMediaManual: "Manual",
  diveMediaEmptyLibrary: "No hay clips indexados alrededor de esta fecha.",
  diveMediaNoneAttached: "Ningún clip de esta fecha está asociado a esta inmersión.",
  diveMediaThumbnailFallback: "No se pueden cargar las miniaturas.",
  diveMediaOpenJellyfin: "Abrir Jellyfin",
  diveMediaRescan: "Re-escanear biblioteca",
  ...
  diveMediaPendingIndex: "{n} clip(s) todavía no están en Jellyfin: aparecen sin miniatura ni enlace hasta que escanee su biblioteca.",
  ...
  diveMediaSearch: "Buscar por nombre",
  diveMediaFilterAll: "Todos",
  diveMediaFilterVideo: "Vídeo",
  diveMediaFilterPhoto: "Foto",
  diveMediaOverlaps: "coincide con la inmersión",
  diveMediaSelectAll: "Seleccionar todo",
  diveMediaClearAll: "Quitar todo",
  diveMediaShowRest: "Ver los {n} restantes",
  diveMediaNoMatches: "Ningún clip coincide con el filtro.",
  diveMediaSave: "Guardar",
  diveMediaCancel: "Cancelar",
  diveMediaNoChanges: "Sin cambios",
  ...
  diveMediaOnProfile: "Clips durante la inmersión",
};

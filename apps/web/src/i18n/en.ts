...
export const en: WebTKeys = {
  ...
  diveSiteMaxDepth: (m: number) => `Max ${m} m`,
  waterTypeSalt: "Salt water",
  waterTypeFresh: "Fresh water",
  waterTypeBrackish: "Brackish water",
  waterTypeChlorinated: "Chlorinated water",
  ...
  diveMediaRemove: "Remove",
  diveMediaManage: "Manage",
  diveMediaManual: "Manual",
  diveMediaEmptyLibrary: "No clips indexed around this date.",
  diveMediaNoneAttached: "No clip from this date is linked to this dive.",
  diveMediaThumbnailFallback: "Thumbnails can't be loaded.",
  diveMediaOpenJellyfin: "Open Jellyfin",
  diveMediaRescan: "Rescan library",
  ...
  diveMediaPendingIndex: "{n} clip(s) are not in Jellyfin yet: no thumbnail or link until it scans its library.",
  ...
  diveMediaSearch: "Search by name",
  diveMediaFilterAll: "All",
  diveMediaFilterVideo: "Video",
  diveMediaFilterPhoto: "Photo",
  diveMediaOverlaps: "overlaps the dive",
  diveMediaSelectAll: "Select all",
  diveMediaClearAll: "Clear all",
  diveMediaShowRest: "Show the other {n}",
  diveMediaNoMatches: "No clip matches the filter.",
  diveMediaSave: "Save",
  diveMediaCancel: "Cancel",
  diveMediaNoChanges: "No changes",
  ...
  diveMediaOnProfile: "Clips during the dive",
};
